...
const CustomNumberInput = ({
  ...
  return (
    <div className="InputContainer">
      <button className="InputButton" onClick={handleDecrement} disabled={!allowed}>
        -
      </button>
      <input className="InputValue"
        ...
        disabled={!allowed}
      />
      <button className="InputButton" onClick={handleIncrement} disabled={!allowed}>
        +
      </button>
    </div>
  );
      ...
      <SimpleGrid columns={1}>
        <>
          <div className="FlexCenter">
            <div>
              <p>Price </p> 
              <h1 className="BigPrice"> {(0.8 * (numberInputValues[buttonGuard.label] !== undefined ? numberInputValues[buttonGuard.label] : 1)).toFixed(2) || 0.8} SOL </h1>
            </div>
            ...
            <CustomNumberInput
              ...
              allowed={buttonGuard.allowed}
              onInputChange={(label, value) =>
                handleNumberInputChange(label, value)
              }
            />
